...
//=============================
 // using the records with find to check when is the win
//   // read about find and see what it returns 
//   // see which condition the find need in order to return a certain element


// function superbowlWin(record){
//   let res = record.find((record)=>{
//     if(record.result === "W"){
//          console.log(record.year)
//       return record.year;
//     }
...
superbowlWin = (record) => { 
   const result = record.find( record => record.result === "W" );  return !!result ? result.year : undefined;
  }
  console.log(superbowlWin);